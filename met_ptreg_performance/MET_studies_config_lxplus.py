...
from met_ptreg_performance.workflow import METProcessor
...
parameters = defaults.merge_parameters_from_files(
    ...
    f"{localdir}/params/jets_calibration_MET_calibrator_noJER_lxplus.yaml",
...
output_chunks_name = (
    ...
    f"root://eosuser.cern.ch//eos/user/m/mmalucch/out_met_2022_preEE_condor/parquet_files"
)
...
cfg = Configurator(
    ...
    datasets={
        "jsons": [
            ...
            f"{localdir}/datasets/DYto2L-4Jets_MLL-50_redirector.json",
        ],
        "filter": {
            "samples": [
                dataset
